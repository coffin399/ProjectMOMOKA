...
| Bot | 役割 | 招待 |
|-----|------|------|
| **PLANA** | プライマリ。LLM・音楽・TTS・画像・通知・tracker・ユーティリティ | [招待リンク](https://discord.com/oauth2/authorize?client_id=1031673203774464160&permissions=6516795221339600&scope=bot) |
| **ARONA** | コンパニオン。LLM・音楽・ユーティリティ。TTS/画像/通知/tracker は PLANA へ誘導 | [招待リンク](https://discord.com/oauth2/authorize?client_id=1364917551024308255&permissions=6516795221339600&scope=bot) |
